...
namespace UltimateCam
{
	public class UltimateCam : MonoBehaviour
	{
		...
		private void fade(Camera from, Camera to, bool destroy)
		{
			if (to != null)
			{
				tmpCams[1] = to;
		...
		private void fade(GameObject cam, Vector3 to, bool movable)
		{
			//TODO
		}
